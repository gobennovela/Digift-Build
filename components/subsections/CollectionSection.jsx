...
function CollectionSection() {
    ...
    return (
        <section className="w-[100%] lg:w-[95%] mx-auto mt-[8vh] lg:mt-[5vh]">
            <div className="w-[100%] lg:w-[90%] mx-auto border-t-[1.5px] border-digiftBorder py-[2vh] lg:py-[7vh] dark:border-headerToggleDark/25">
                <div className="w-[100%] mx-auto">
                    <h3 className="text-[1.5em] ml-[8vw] lg:ml-[0vw] font-semibold text-left tracking leading-auto text-darkText dark:text-white">All collections</h3>
