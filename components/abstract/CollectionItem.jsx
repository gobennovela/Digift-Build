      ...
      <div className="grid grid-cols-1 lg:gap-[2em] items-center justify-center mx-auto md:grid-cols-2 lg:grid-cols-3 gap-[1em]">
        ...
        <>
            <div key={item.id} className="border-[4px] lg:border-[8px] mx-auto border-lightBgColor dark:border-headerToggleDark/20 rounded-[1em] w-[83.47222222222222vw] md:w-[32vw] lg:w-[25vw] px-[12px] pt-[12px] bg-transparent overflow-hidden">
              <div className="w-[100%] h-[82.833333333333332vw]  bg-lightBgColor dark:bg-headerToggleDark/25 md:h-[25.8333333332vw] lg:h-[21.933333333333332vw] flex flex-col rounded-[8px] border-[1px] dark:border-headerToggleDark/50 border-digiftBorder object-contain overflow-hidden">
                <img src={`${item.imageUrl}`} alt="" loading="lazy" className="w-[110%]" />
              </div>
              <div className="my-[1em] p-[0.5em] flex flex-col items-start justify-between text-ellipsis">
                ...
                <p className="text-[14px] font-medium max-w-[95%] max-h-[9vh] overflow-hidden text-prevalentText dark:text-gray-300 overflow-ellipsis leading-[2]">{item.description}</p>
